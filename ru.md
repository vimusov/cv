# Кузнецов Вадим Олегович

- **Позиция:** Ведущий разработчик.
- **Специализация:** Проектирование архитектуры программно-аппаратных продуктов в сфере сетевой безопасности.
- **Общий рабочий стаж:** 16 лет.
- **Условия сотрудничества:** Полный день; Удалённая работа.
...
1. Провёл рефакторинг инфраструктуры CI в части обеспечения контроля за исходным кодом, реализовав
   и внедрив линтеры для статической проверки кода. Средства реализации: Python, pylint, mypy, Jenkins.
...
- **Telegram:** [@vimusov](https://t.me/vimusov)
